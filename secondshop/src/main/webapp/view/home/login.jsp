...
<body
	...
	<div style="margin: 20px auto">
		<div style="margin: 100px auto; margin-bottom: 40px" align="center">
			<h1 style="font-size: 60px">欢迎登录校园二手交易系统</h1>
		</div>
	</div>
	...
	<div class="container" style="position: relative; margin: 80px auto;">
		<div class="col-md-6 login-back"
			...
			<form action="/secondshop/LoginServlet" method="post">
			...
			<a href="/secondshop/view/admin/adminLogin.jsp">管理员登录</a>
			<a style="float: right" href="/secondshop/view/home/homeGoods.jsp">返回首页</a>
		</div>
	</div>
