...
<script>
    ...
    function delOrder(orderId) {
        $.ajax({
            type: "POST",
            url: "/secondshop/OrderServlet?method=userDelete&id=" + orderId,
            ...
            success: function (data) {
                ...
                if (data === false) {
                    ...
                    alert("订单删除成功！");
                    location.href='/secondshop/UserServlet?method=display';
                }
            }
        });
    }
    ...
    function selectValue() {
        $.getJSON("/secondshop/OrderServlet?method=setStatus" , function (data) {
            if (data == false) {
                alert("操作失败！");
            } else {
                alert("操作成功！");
